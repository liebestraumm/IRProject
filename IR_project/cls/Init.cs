...
namespace IR_project
{
    class Init
    {
        private static Lucene.Net.Util.Version Version = Lucene.Net.Util.Version.LUCENE_30;
        ...
        public Lucene.Net.Util.Version getVersion()
        {
            return Version;
        }
        ...
        public Lucene.Net.Analysis.Analyzer getAnalyser()
        {
            return analyzer;
        }
    }
